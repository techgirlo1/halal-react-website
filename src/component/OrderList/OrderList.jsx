          ...
          <Container className='text-start mt-5'>
            ...
            <Modal show={state.show} onHide={handleClose}>
              <Modal.Header closeButton>
                <Modal.Title>READ CAREFULLY</Modal.Title>
              </Modal.Header>
              <Modal.Body>
                <p style={{fontSize:"12px"}}>Your Order Has Been Received. Kindly make Your Payment To this
                Account 2211145676, Bank: WEMA bank, Account Name: Firdaus. Use
                your Invoice Number as The payment description for your payment to
                be confirmed. Note:Order outside Edo state attract the delivery charges of 4000 naira only,while within edo state attract  charges of 2000 nairA.We will Only Deliver your Product if Your Payment is completed. Thanks For Your Patronage</p>
              </Modal.Body>
              <Modal.Footer>
